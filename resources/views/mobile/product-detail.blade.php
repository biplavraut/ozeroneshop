...
<header class="header header--fixed header--change">	
	...
	<div class="page__content page__content--with-header">	
		<!-- SLIDER SIMPLE -->
		<div class="swiper-container slider-simple slider-simple slider-simple--vw-width slider-simple--detail-height slider-init" data-paginationtype="bullets" data-spacebetweenitems="0" data-itemsperview="1">
		...
		<div class="mb-40" id="loadlist-shop">	
