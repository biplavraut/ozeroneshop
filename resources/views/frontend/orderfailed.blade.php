...
<html class="no-js" lang="en">
    <head>
        <title>Order Failed - Ozerone Shop</title>
        <meta charset="utf-8">
        <!-- CSRF Token -->
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-8 col-lg-6">
                        <h1 class="alt-font text-extra-dark-gray font-weight-500 no-margin-bottom text-center text-lg-left">Order Failed</h1>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 text-center margin-seven-bottom">
                        <h6 class="alt-font text-extra-dark-gray font-weight-500">Order Failed</h6>
                    </div>
                </div>
                <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2">
                    ...
                    <div class="col text-center process-step-style-01 last-paragraph-no-margin md-margin-50px-bottom wow animate__fadeIn">
                        <div class="process-step-icon-box margin-40px-bottom sm-margin-30px-bottom">
                            ...
                            <div class="process-step-icon bg-white"><i class=" line-icon-Angry icon-large text-gradient-light-purple-light-orange"></i></div>
                        </div>
                        <span class="alt-font d-block font-weight-500 text-extra-dark-gray margin-10px-bottom">Order Failed</span>
                        <p class="w-85 d-inline-block lg-w-100 md-w-70 sm-w-90">Your order has not been placed.</p>
                    </div>
