    ...
    <body data-mobile-nav-style="classic">
        ...
        <section class="wow animate__fadeIn">
            <div class="container">
                ...
                <p>These terms and conditions outline the rules and regulations for the use of Ozerone's Website, located at www.ozeroneshop.com.                </p>
                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Ozerone if you do not agree to take all of the terms and conditions stated on this page.
                </p>
                ...
                <b>Cookies</b>
                <p>We employ the use of cookies. By accessing Ozerone, you agreed to use cookies in agreement with the Ozerone's Privacy Policy.
                    Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.
                    </p>
                <b>License</b>
                <p>Unless otherwise stated, Ozerone and/or its licensors own the intellectual property rights for all material on Ozerone. All intellectual property rights are reserved. You may access this from Ozerone for your own personal use subjected to restrictions set in these terms and condition</p>
                    <p>You must not:</p>
                    <ul style="padding: 20px;">
                        <li>Republish material from Ozerone</li>
                        <li>Sell, rent or sub-license material from Ozerone</li>
                        <li>Reproduce, duplicate or copy material from Ozerone</li>
                        <li>Redistribute content from Ozerone</li>
                    </ul>
                    <p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the Terms And Conditions Generator and the Privacy Policy Generator.
                    <br>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Ozerone does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Ozerone,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Ozerone shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.<br>Ozerone reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Condition</p>
                    ...
                    <p>You hereby grant Ozerone a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
                    </p>
                <b>Hyperlinking to our Conten</b>
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Ozerone; and (d) the link is in the context of general resource information.
                ...
                <br> If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Ozerone. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.
            ...
            <p>No use of Ozerone's logo or other artwork will be allowed for linking absent a trademark license agreement.
            </p>
            <b>iFrames</b>
            ...
            <b>Removal of links from our websit</b>
