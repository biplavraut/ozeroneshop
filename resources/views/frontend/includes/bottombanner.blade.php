...
<div class="bottom-navigation fixed-bottom-bar">
    <ul class="bottom-navigation__icons">
        ...
        @if (Cart::count() > 0)
        <li id="checkout-reload"><a href="/checkout"><img src="{{asset('mobile/assets/images/icons/blue/checkout.svg')}}" alt="Checkout" title="Checkout" /><span>Checkout</span></a></li>
        @else
        <li id="checkout-reload"><a href="#" data-container="body" data-toggle="popover" data-placement="top" data-content="Please add product in Cart"><img src="{{asset('mobile/assets/images/icons/blue/checkout.svg')}}" alt="Checkout" title="Empty Cart" /><span>Checkout</span></a></li>
        @endif
        @auth
