<template>
    <div class="container">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Region General Information</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group mb-2 mr-sm-2">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">Elevation</div>
                                            </div>
                                            <input v-model="cform.elevation" type="text" name="elevation"
                    ...
                    <div class="card card-dark">
                        <div class="card-header">
                            <h3 class="card-title">Add Map </h3>
                            <div class="card-tools">
                                <div class="card-tools">
                                    <a v-on:click="newMap" class="btn btn-primary"><i class="fas fa-images fa-fw"></i> Add Map</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3 mt-4">
                                    <img class="img-lg elevation-3" :src="getImages(cform.map)"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <div class="row">                                
                                <div class="col-md-3 mt-4">
                                    <img class="img-lg elevation-3" :src="getImages(cform.display_image)"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3 mt-4">
                                    <img class="img-lg elevation-3" :src="getImages(cform.cover_image)"/>
                                </div>
                    ...
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3 mt-4"  v-for="(img, index) in images" :key="index">
                                    <template v-if="getImages(img)">
        ...
        <!--End of modal-->
        <!-- Modal Image -->
        <div class="modal fade" id="addNewMap" tabindex="-1" role="dialog" aria-labelledby="addNewMapLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addNewMapLabel">Add Map</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="file" name="map"  @change="uploadMap"
                                           placeholder="Map"
                                           class="btn btn-sm btn-info" :class="{ 'is-invalid': cform.errors.has('map') }">
                                    <has-error :form="cform" field="map"></has-error>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                    ...
                    <form  @submit.prevent="addImage()">
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">All Image</div>
                                    </div>
        ...
        <div class="modal fade" id="addNewCoverImage" tabindex="-1" role="dialog" aria-labelledby="addNewCoverImageLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addNewCoverImageLabel">Add Cover Image</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="file" name="cover_image"  @change="uploadCoverImage"
                                           placeholder="Cover Image"
                                           class="btn btn-sm btn-info" :class="{ 'is-invalid': cform.errors.has('cover_image') }">
                                    <has-error :form="cform" field="cover_image"></has-error>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="file" name="display_image" @change="uploadDisplayImage"
                                           placeholder="Display Image"
                                           class="btn btn-sm btn-info" :class="{ 'is-invalid': cform.errors.has('display_image') }">
                                    <has-error :form="cform" field="display_image"></has-error>
                                </div>
                            </div>
    ...
    export default {
        ...
        methods : {
            ...
            createDetail(){
                ...
                this.form.post('../api/regiondetail') // POST form data
            ...
            updateDetail(id){
                ...
                this.form.put('../api/regiondetail/'+this.form.id)
                    .then(() =>{
                        $("#addNewDetail").modal('hide'); //Hide the model
                        swal.fire(
                            'Updated!',
            ...
            updateContent(id){
                ...
                this.$Progress.start();
                //console.log('editing data');
                this.cform.put('../api/regions/'+this.cform.id)
                    .then(() =>{
            ...
            deleteDetail(id){
                swal.fire({
                    ...
                    if (result.value) {
                        this.form.delete('../api/regiondetail/' + id).then(() => {
                            swal.fire(
                                'Deleted!',
            ...
            getImages(img){
                ...
                let test = img;
                let photo = "/img/regions/" + slug + "/" +img;
                if (img == null){
                photo =  "/img/regions/no-image.png";
                }
                return photo;
            },
            getCoverImages(img){
            ...
            uploadCoverImage(e) {
                ...
                if (file['size'] < 2111775) {
                    reader.onloadend = (file) => {
                        //console.log('RESULT', reader.result)
                        this.cform.cover_image = reader.result;
                    }
                    reader.readAsDataURL(file);
                } else {
                    swal.fire(
            ...
            uploadDisplayImage(e) {
                ...
                if (file['size'] < 2111775) {
                    reader.onloadend = (file) => {
                        //console.log('RESULT', reader.result)
                        this.cform.display_image = reader.result;
                    }
                    reader.readAsDataURL(file);
                } else {
                    swal.fire(
                ...
                reader.onloadend = (e) => {
                    ...
                    image.onload = function (){
                        ...
                        if (height == 460 && width == 460) { 
                            ...
                            swal.fire(
                                'Opps..!',
                                'Height and Width must not exceed 460px',
                                'warning'
                            )
                            //return false;
                        }
            ...
            addCoverImage(){
                //console.log(newcontent);
                this.cform.post('../api/regionCoverImage') // POST form data
                //Start Condition to check form is validate
                    .then(()=>{
                        Fire.$emit('AfterCreate'); //custom event to reload data
            ...
            addDisplayImage(){
                //console.log(newcontent);
                this.cform.post('../api/regionDisplayImage') // POST form data
                //Start Condition to check form is validate
                    .then(()=>{
                        Fire.$emit('AfterCreate'); //custom event to reload data
            ...
            addMap(){
                //console.log(newcontent);
                this.cform.post('../api/regionMap') // POST form data
                //Start Condition to check form is validate
                    .then(()=>{
                        Fire.$emit('AfterCreate'); //custom event to reload data
                        $("#addNewMap").modal('hide'); //Hide the model
                        //Sweetalert notification for the result
                        Toast.fire({
                            type: 'success',
            ...
            loadDetail(){
                ...
                if (this.$gate.isAuthorized()){
                    axios.get("../api/regions?slug="+this.contentid).then(({ data }) => (
                    ...
                    axios.get('../api/regiondetail?slug='+this.contentid).then(({ data }) => (
        ...
        created() {
            Fire.$on('searching',()=>{
                ...
                axios.get('../api/findRegionDetail?q='+ query)
                    .then((data)=>{
