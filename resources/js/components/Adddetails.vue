                ...
                <div class="col-md-8">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Trip General Information</h3>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3 mt-4"  v-for="(img, index) in images" :key="index" v-if="getMap(img)">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3 mt-4"  v-for="(img, index) in images" :key="index" v-if="getDisplayImages(img)">
                                        <img class="img-lg elevation-3" :src="getDisplayImages(img)"/>
                                </div>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="file" name="coverimages"  @change="uploadCoverImage"
                            ...
                            <div class="form-group">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="file" name="displayimages"  @change="uploadDisplayImage"
                                           ...
                                           class="btn btn-sm btn-info" :class="{ 'is-invalid': cform.errors.has('displayimage') }">
                                    <has-error :form="cform" field="displayimage"></has-error>
                                </div>
                            </div>
    ...
    export default {
        ...
        methods : {
            ...
            createDetail(){
                ...
                this.form.post('../api/detail') // POST form data
            ...
            updateContent(id){
                ...
                this.$Progress.start();
                //console.log('editing data');
                this.cform.put('../api/content/'+this.cform.id)
                    .then(() =>{
            ...
            getImages(img){
                ...
                let test = img;
                let photo = "/img/contents/" + slug + "/" +img;
                return photo;
            },
            getCoverImages(img){
                let slug = this.contentid;
            ...
            uploadDisplayImage(e) {
                ...
                if (file['size'] < 2111775) {
                    reader.onloadend = (file) => {
                        //console.log('RESULT', reader.result)
                        this.cform.displayimage = reader.result;
                    }
                    reader.readAsDataURL(file);
                } else {
                    swal.fire(
            ...
            addMap(){
                ...
                this.cform.post('../api/contentMap') // POST form data
                //Start Condition to check form is validate
                    .then(()=>{
                        Fire.$emit('AfterCreate'); //custom event to reload data
            ...
            addCoverImage(){
                //console.log(newcontent);
                this.cform.post('../api/detailCoverImage') // POST form data
                //Start Condition to check form is validate
                    .then(()=>{
                        Fire.$emit('AfterCreate'); //custom event to reload data
            ...
            addDisplayImage(){
                //console.log(newcontent);
                this.cform.post('../api/detailDisplayImage') // POST form data
                //Start Condition to check form is validate
                    .then(()=>{
                        Fire.$emit('AfterCreate'); //custom event to reload data
            ...
            loadDetail(){
                ...
                if (this.$gate.isAuthorized()){
                    axios.get("../api/content?slug="+this.contentid).then(({ data }) => (
                    ...
                    axios.get('../api/detail?slug='+this.contentid).then(({ data }) => (
