            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Categories Management: {{this.shop_section}}</h3>

                        <div class="card-tools">
                            <button type="" @click="newElectronics" class="btn btn-primary"><i class="fas fa-bars fa-fw"></i> Add New</button>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body table-responsive p-2">
                        <table class="table table-hover">
                            <vue-nestable v-model="electronics" :max-depth="2" v-on:change="listChange(electronics)">
                                    ...
                                    <vue-nestable-handle :item="item">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 item_actions">
                                                <a href="#" @click="editElectronics(item)" class="btn btn-sm btn-success">Edit
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="#" @click="deleteelEctronics(item.slug)" class="btn btn-sm btn-danger">Delete
