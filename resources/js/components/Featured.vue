<template>
    <div>
        <base-header class="pb-6 pb-8 pt-5 pt-md-8 bg-gradient-warning">
            ...
            <b-row>
                ...
                <router-link to="/backend/admin/featured">
                    <button type="button" title="Featured Management" data-clipboard-text="air-baloon" class="bg-gradient-default btn-icon-clipboard">
                        <div>
                            <span class="d-none d-md-block"><i class="fas fa-sliders-h"></i><span class="text-white">Featured Products</span></span>
        ...
        <b-container fluid class="mt--7">
                ...
                <b-col xl="12" class="mb-5 mb-xl-0">
                    <card type="default" header-classes="bg-transparent">
                        <b-row align-v="center" slot="header">
                            <b-col>
                                <h6 class="text-light text-uppercase ls-1 mb-1">Featured Products</h6>
                            ...
                            <b-col>
                                ...
                                <b-nav-item
                                    ...
                                    @click="newFeatured">
                                    <span class="d-none d-md-block"><i class="fas fa-plus"></i> Add New Featured Product</span>
                        ...
                        <b-skeleton-wrapper :loading="loading">
                            ...
                            <b-card-body class="pt-0">
                                <vue-nestable 
                                    v-model="featureds" 
                                    :max-depth="1" 
                                    v-on:change="listChange(featureds)">
                                        ...
                                        <vue-nestable-handle :item="item" class="mt-2">
                                            <b-row align-v="center">
                                                ...
                                                <b-col class="text-right">
                                                    <a href="#" @click="editFeatured(item)" class="btn btn-sm btn-success">
                                                        <span class="d-none d-md-block"><i class="fas fa-edit"></i> Edit</span>
                                                        <span class="d-md-none"><i class="fas fa-edit"></i></span>
                                                    </a>
                                                    <a href="#" @click="deleteFeatured(item.slug)" class="btn btn-sm btn-danger">
            ...
            <!-- Modal -->
            <div class="modal fade" id="addNewFeatured" tabindex="-1" role="dialog" aria-labelledby="addNewFeaturedLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" v-show="!editmode" id="addNewFeaturedLabel">Add New Featured Product</h5>
                            <h5 class="modal-title" v-show="editmode" id="addNewFeaturedLabel">Update Featured Product</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form  @submit.prevent="editmode ? updateFeatured() : createFeatured()">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-2 mr-sm-2">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">Brand or Title</div>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="input-group mb-2 mr-sm-2">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">Sub title Color</div>
                                                </div>
                                                <input v-model="form.sub_title_color" type="text" name="sub_title_color"
                                                    placeholder="Sub Title Color"
                                                    class="form-control" :class="{ 'is-invalid': form.errors.has('sub_title_color') }">
                                                <has-error :form="form" field="sub_title_color"></has-error>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <img v-show="editmode" class="img-fluid" :src="'/img/featured/'+form.image">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-2 mr-sm-2">
                                                ...
                                                <input v-model="form.price" type="text" name="price"
                                                    placeholder="Featured Product Price"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <vue-editor v-model="form.excerpt" placeholder="Short Discription"></vue-editor>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    export default {
        ...
        methods : {
            ...
            createFeatured(){
                ...
                this.form.post('/api/featured') // POST form data
                //Start Condition to check form is validate
                    .then(({data})=>{
                        $("#addNewFeatured").modal('hide'); //Hide the model
                        this.form.reset();
                        this.$refs["image"].value = "";
            ...
            listChange(newfeatured){
                //console.log(newcontent);

                axios({
                    method: 'post',
                    url: '/api/orderFeatured',
                    data: {
                        newfeatured
                    },
                })
                //Start Condition to check form is validate
                    .then(()=>{
                        ...
                        Toast.fire({
                            type: 'success',
                            title: 'Featured Sorted Successfully'
                        })
            ...
            editFeatured(featureds){
                this.editmode = true;
                this.form.reset();
                $('#addNewFeatured').modal('show');
                this.form.fill(featureds);
            },
            /*Edit Featured Function*/
            updateFeatured(){
                this.$Progress.start();
                //console.log('editing data');
                this.form.put('/api/featured/'+this.form.slug)
                    .then(({data}) =>{
                        console.log(data);
                        this.form.reset();
                        this.$refs["image"].value = "";
            ...
            deleteFeatured(slug){
                ...
                swal.fire({
                    ...
                    if (result.value) {
                        this.form.delete('/api/featured/' + slug).then(({data}) => {
                            this.serverResponse(data);
                        }).catch(() => {
                            swal.fire(
                                'Oops!',
            ...
            loadFeatured(){
                if (this.$gate.isAuthorized()){
                    axios.get("/api/featured").then(({ data }) => (this.featureds = data, this.totalfeatured = data.total));
                }
            }
        },
        created() {
            ...
            Fire.$on('searching',()=>{
                ...
                axios.get('/api/findFeatured?q='+ query)
                    .then(({ data })=>{
                        this.featureds = data
                    }).catch(()=>{
            ...
            this.loadFeatured(); //load the user in the table
